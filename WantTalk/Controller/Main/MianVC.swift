...
class MianVC: NSViewController,NSTableViewDelegate,NSTableViewDataSource,IMMessagListDelegate {
    //实时检查网络状态
...
/*
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let messageList = self.messageList[indexPath.row]
        if messageList.isGroupChat == true {
            ...
            // 進入群聊頁面
            let chatController: IMGroupChatViewController = IMGroupChatViewController()
