...
extension NSImage {
     ...
     */
    /*
    func wxCompress(type: WechatCompressType = .timeline) -> NSImage {
 ...
 */
    ...
    /**
     ...
     - returns: new image
     */
    private func resizedImage(size: CGSize) -> NSImage {
//        let newRect = CGRect(x: 0, y: 0, width: size.width, height: size.height)
//        var newImage: NSImage!
//        UIGraphicsBeginImageContext(newRect.size)
//        newImage = NSImage(cgImage: self.cgImage!, scale: 1, orientation: self.imageOrientation)
