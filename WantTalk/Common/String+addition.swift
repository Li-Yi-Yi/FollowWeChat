...
extension String{
    public func getHeightWith(font:NSFont,width:CGFloat) ->CGFloat{
        let atts = [NSFontAttributeName:font]
        
        let size = CGSize(width:width, height:10000)
        
        let rect = (self as NSString).boundingRect(with: size, options: .usesLineFragmentOrigin, attributes: atts, context: NSStringDrawingContext())
